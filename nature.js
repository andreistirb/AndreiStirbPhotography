...
function thumb1()
{
	...
	if (current==1)
	{nextImage.src="gallery/nature/pictures/1.jpg";}	
	else
	{nextImage.src="gallery/nature/pictures/"+gallery_array[current];}
...
function thumb2()
{
	...
	if (current==1){
	nextImage.src="gallery/nature/pictures/2.jpg";}
	else
	nextImage.src="gallery/nature/pictures/"+gallery_array[current+1];
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=1;
	document.getElementById("numar").innerHTML=current+x+"/"+y;
...
function thumb3()
{
	...
	if (current==1){
	nextImage.src="gallery/nature/pictures/3.jpg";}
	else
	nextImage.src="gallery/nature/pictures/"+gallery_array[current+2];
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=2;
	document.getElementById("numar").innerHTML=current+x+"/"+y;
...
function thumb4()
{
	...
	if (current==1){
	nextImage.src="gallery/nature/pictures/4.jpg";}
	else
	nextImage.src="gallery/nature/pictures/"+gallery_array[current+3];
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=3;
	document.getElementById("numar").innerHTML=current+x+"/"+y;
...
function thumb5()
{
	...
	if (current==1){
	nextImage.src="gallery/nature/pictures/5.jpg";}
	else
	nextImage.src="gallery/nature/pictures/"+gallery_array[current+4];
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=4;
	document.getElementById("numar").innerHTML=current+x+"/"+y;
...
function thumb6()
{
	...
	if (current==1){
	nextImage.src="gallery/nature/pictures/6.jpg";}
	else
	nextImage.src="gallery/nature/pictures/"+gallery_array[current+5];
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=5;
	document.getElementById("numar").innerHTML=current+x+"/"+y;
...
function thumb7()
{
	...
	if (current==1){
	nextImage.src="gallery/nature/pictures/7.jpg";}
	else
	nextImage.src="gallery/nature/pictures/"+gallery_array[current+6];
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=6;
	document.getElementById("numar").innerHTML=current+x+"/"+y;
...
function thumb8()
{
	...
	if (current==1){
	nextImage.src="gallery/nature/pictures/8.jpg";}
	else
	nextImage.src="gallery/nature/pictures/"+gallery_array[current+7];
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=7;
	document.getElementById("numar").innerHTML=current+x+"/"+y;
...
function thumb9()
{
	...
	if (current==1){
	nextImage.src="gallery/nature/pictures/9.jpg";}
	else
	nextImage.src="gallery/nature/pictures/"+gallery_array[current+8];
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=8;
	document.getElementById("numar").innerHTML=current+x+"/"+y;
...
function thumb10()
{
	...
	if (current==1){
	nextImage.src="gallery/nature/pictures/10.jpg";}
	else
	nextImage.src="gallery/nature/pictures/"+gallery_array[current+9];
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=9;
	document.getElementById("numar").innerHTML=current+x+"/"+y;
...
function thumb11()
{
	...
	if (current==1){
	nextImage.src="gallery/nature/pictures/11.jpg";}
	else
	nextImage.src="gallery/nature/pictures/"+gallery_array[current+10];
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=10;
	document.getElementById("numar").innerHTML=current+x+"/"+y;
...
function thumb12()
{
	...
	if (current==1){
	nextImage.src="gallery/nature/pictures/12.jpg";}
	else
	nextImage.src="gallery/nature/pictures/"+gallery_array[current+11];
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=11;
	document.getElementById("numar").innerHTML=current+x+"/"+y;
...
function thumb13()
{
	...
	nextImage.src="gallery/nature/pictures/13.jpg";
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=12;
...
function thumb14()
{
	...
	nextImage.src="gallery/nature/pictures/14.jpg";
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=13;
	document.getElementById("numar").innerHTML=1+x+"/"+y;
...
function jos(){
	...
	document.getElementById("thumb_1").setAttribute("src","gallery/nature/thumbnails/"+gallery_array[current]);
	document.getElementById("thumb_2").setAttribute("src","gallery/nature/thumbnails/"+gallery_array[current+1]);
	document.getElementById("thumb_3").setAttribute("src","gallery/nature/thumbnails/"+gallery_array[current+2]);
	document.getElementById("thumb_4").setAttribute("src","gallery/nature/thumbnails/"+gallery_array[current+3]);
	document.getElementById("thumb_5").setAttribute("src","gallery/nature/thumbnails/"+gallery_array[current+4]);
	document.getElementById("thumb_6").setAttribute("src","gallery/nature/thumbnails/"+gallery_array[current+5]);
	document.getElementById("thumb_7").setAttribute("src","gallery/nature/thumbnails/"+gallery_array[current+6]);
	document.getElementById("thumb_8").setAttribute("src","gallery/nature/thumbnails/"+gallery_array[current+7]);
	document.getElementById("thumb_9").setAttribute("src","gallery/nature/thumbnails/"+gallery_array[current+8]);
	document.getElementById("thumb_10").setAttribute("src","gallery/nature/thumbnails/"+gallery_array[current+9]);
	document.getElementById("thumb_11").setAttribute("src","gallery/nature/thumbnails/"+gallery_array[current+10]);
	document.getElementById("thumb_12").setAttribute("src","gallery/nature/thumbnails/"+gallery_array[current+11]);
	return;
}
