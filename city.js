...
function thumb1()
{
	...
	if (current==1)
	{nextImage.src="gallery/city/pictures/1.jpg";}	
	else
	{nextImage.src="gallery/city/pictures/"+gallery_array[current];}
...
function thumb2()
{
	...
	if (current==1){
	nextImage.src="gallery/city/pictures/2.jpg";}
	else
	nextImage.src="gallery/city/pictures/"+gallery_array[current+1];
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=1;
	document.getElementById("numar").innerHTML=current+x+"/"+y;
...
function thumb3()
{
	...
	if (current==1){
	nextImage.src="gallery/city/pictures/3.jpg";}
	else
	nextImage.src="gallery/city/pictures/"+gallery_array[current+2];
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=2;
	document.getElementById("numar").innerHTML=current+x+"/"+y;
...
function thumb4()
{
	...
	if (current==1){
	nextImage.src="gallery/city/pictures/4.jpg";}
	else
	nextImage.src="gallery/city/pictures/"+gallery_array[current+3];
	var imageDiv=document.getElementById("imagine");
	imageDiv.replaceChild(nextImage,imageDiv.childNodes[1]);
	x=3;
	document.getElementById("numar").innerHTML=current+x+"/"+y;
...
function jos(){
	...
	document.getElementById("thumb_1").setAttribute("src","gallery/city/thumbnails/"+gallery_array[current]);
	document.getElementById("thumb_2").setAttribute("src","gallery/city/thumbnails/"+gallery_array[current+1]);
	document.getElementById("thumb_3").setAttribute("src","gallery/city/thumbnails/"+gallery_array[current+2]);
	document.getElementById("thumb_4").setAttribute("src","gallery/city/thumbnails/"+gallery_array[current+3]);
	document.getElementById("thumb_5").setAttribute("src","gallery/city/thumbnails/"+gallery_array[current+4]);
	document.getElementById("thumb_6").setAttribute("src","gallery/city/thumbnails/"+gallery_array[current+5]);
	document.getElementById("thumb_7").setAttribute("src","gallery/city/thumbnails/"+gallery_array[current+6]);
	document.getElementById("thumb_8").setAttribute("src","gallery/city/thumbnails/"+gallery_array[current+7]);
	document.getElementById("thumb_9").setAttribute("src","gallery/city/thumbnails/"+gallery_array[current+8]);
	document.getElementById("thumb_10").setAttribute("src","gallery/city/thumbnails/"+gallery_array[current+9]);
	document.getElementById("thumb_11").setAttribute("src","gallery/city/thumbnails/"+gallery_array[current+10]);
	document.getElementById("thumb_12").setAttribute("src","gallery/city/thumbnails/"+gallery_array[current+11]);
	return;
}
